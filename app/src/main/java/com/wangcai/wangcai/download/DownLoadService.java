package com.wangcai.wangcai.download;
...
import com.wangcai.wangcai.download.fileload.FileCallback;
import com.wangcai.wangcai.download.fileload.FileResponseBody;
        ...
        retrofit.baseUrl(APIService.SERVER_IP)
                ...
                .enqueue(new FileCallback(destFileDir, destFileName) {
                    ...
                    public void onSuccess(File file) {
                        ...
                        cancelNotification();
                        installApk(file);
                        WebMainActivity.mUpdateLoading.dismiss();
                    }
